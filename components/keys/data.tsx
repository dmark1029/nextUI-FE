...
export const columns = [
  ...
  { name: "User Subnets", uid: "userSubnets" },
  { name: "Account Password", uid: "accountPassword" },
  { name: "API Key", uid: "apiKey" },
  { name: "Service Link", uid: "serviceLink" },
];
...
const generateMockApiKeys = (count: number): Keys[] => {
  const mockData: Keys[] = [];

  for (let i = 0; i < count; i++) {
    const key: Keys = {
      id: i,
      subnetName: "subnet123" + i,
      accountName: "User" + i,
      userSubnets: [
        "Design",
        "Product",
      ...
      apiKey: "key" + i,
      serviceLink: "https://example.com" + i,
    };
...
export const keys: Keys[] = generateMockApiKeys(100);
